  ...
  if (showSoundPrompt) {
    return (
      <Fragment>
        ...
        <div className="fixed inset-0 bg-black flex items-center justify-center z-50">
          <div className="text-center text-white p-8 max-w-md" style={{
            padding: 'calc(32px * var(--viewport-scale, 1))',
            maxWidth: 'calc(448px * var(--viewport-scale, 1))'
          }}>
            <div className="mb-8" style={{
              marginBottom: 'calc(32px * var(--viewport-scale, 1))'
            }}>
              <svg 
                ...
                viewBox="0 0 24 24"
                style={{
                  width: 'calc(96px * var(--viewport-scale, 1))',
                  height: 'calc(96px * var(--viewport-scale, 1))',
                  marginBottom: 'calc(16px * var(--viewport-scale, 1))'
                }}
              >
                <path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02zM14 3.23v2.06c2.89.86 5 3.54 5 6.71s-2.11 5.85-5 6.71v2.06c4.01-.91 7-4.49 7-8.77s-2.99-7.86-7-8.77z"/>
              </svg>
            </div>
            <h1 className="font-bold mb-4 font-[Nasalization]" style={{
              fontSize: 'calc(24px * var(--viewport-scale, 1))',
              marginBottom: 'calc(16px * var(--viewport-scale, 1))'
            }}>Sound Experience</h1>
            <p className="mb-8 font-[Gilmer]" style={{
              fontSize: 'calc(18px * var(--viewport-scale, 1))',
              marginBottom: 'calc(32px * var(--viewport-scale, 1))'
            }}>
              Choose your preferred audio experience for the website.
            </p>
            <div className="space-y-4" style={{
              gap: 'calc(16px * var(--viewport-scale, 1))'
            }}>
              <button
                onClick={() => handleSoundChoice(true)}
                className="w-full bg-cyan-400/20 border border-cyan-400 rounded-lg hover:bg-cyan-400/30 hover:border-cyan-300 transition-all duration-300 font-[Gilmer]"
                style={{
                  padding: 'calc(16px * var(--viewport-scale, 1)) calc(24px * var(--viewport-scale, 1))',
                  fontSize: 'calc(18px * var(--viewport-scale, 1))'
                }}
              >
                <div className="flex items-center justify-center space-x-3" style={{
                  gap: 'calc(12px * var(--viewport-scale, 1))'
                }}>
                  <svg style={{
                    width: 'calc(24px * var(--viewport-scale, 1))',
                    height: 'calc(24px * var(--viewport-scale, 1))'
              ...
              <button
                ...
                className="w-full bg-white/10 border border-white/20 rounded-lg hover:bg-white/20 hover:border-white/30 transition-all duration-300 font-[Gilmer]"
                style={{
                  padding: 'calc(16px * var(--viewport-scale, 1)) calc(24px * var(--viewport-scale, 1))',
                  fontSize: 'calc(18px * var(--viewport-scale, 1))'
                }}
